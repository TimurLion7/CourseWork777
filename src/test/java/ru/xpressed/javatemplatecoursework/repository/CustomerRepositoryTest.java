...
public class CustomerRepositoryTest {
    ...
    public void findByUsername_1() {
        ...
        Assertions.assertEquals("test", customerRepository.findByUsername("test").getUsername());
    }
    ...
    public void findByUsername_2() {
        ...
        Assertions.assertEquals("1234", customerRepository.findByUsername("test").getPassword());
